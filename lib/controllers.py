...
class PurePursuitController:
    ...
    # t between 0 and 1
    def step(self, t):
        x, y, theta, v = self.model.get_state()
        ...
        alpha = np.arctan2(lookaheadPoint[1], lookaheadPoint[0])
        ...
        # TODO calculations:
        # 1. find closest point on path relative to current position
        # 2. calculate lookahead point given lookahead distance from closest point
        # 3. 
